...
var Arduino = require('./connections/arduino.js');
...
exports.init = function(){
	...
	this.connectionTypes['desklamp'] = this.arduino;
	
	this.connectionTypes['door'] = this.virtual_home;
...
exports.process_command = function( command ){
	answer = '';
	console.log(command.value.toLowerCase());
	switch ( command.name ){
		case 'turnOn':
		...
		case 'turnOff':
			...
			break;
		case 'open':
			$(command.value.toLowerCase() ).open();
			break;
		default:
			break;
	}
